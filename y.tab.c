...
static const yytype_uint8 yyprhs[] =
{
      ...
      34,    38,    40,    44,    46,    50,    52,    54
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      17,     0,    -1,    18,    10,    -1,     5,    19,     8,    -1,
      20,    -1,    19,    20,    -1,    11,     9,    23,     4,    -1,
       6,    13,    21,    14,     4,    -1,     7,    13,    22,    14,
       4,    -1,    11,    -1,    11,     3,    21,    -1,    23,    -1,
      23,     3,    22,    -1,    24,    -1,    23,    12,    24,    -1,
      11,    -1,    15,    -1,    13,    23,    14,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    58,    58,    59,    68,    69,    71,    72,    73,    76,
      77,    80,    81,    84,    85,    87,    88,    89
};
#endif
...
{
  "$end", "error", "$undefined", "COMA", "PUNTOYCOMA", "INICIO", "LEER",
  "ESCRIBIR", "FIN", "ASIGNACION", "FDT", "ID", "OPERADOR", "PARIZQ",
  "PARDER", "CONSTANTE", "$accept", "objetivo", "programa",
...
{
      12,     8,    18,    10,     9,    11,    14,     5,   -13,   -13,
     -13,    15,    -7,    -7,   -13,   -13,    22,     7,   -13,    -7,
     -13,    13,    -3,   -13,    -2,    15,    24,    -9,    25,    -7,
...
{
      29,    24,    31,    30,    18,    34,    19,    27,    20,    30,
      30,     4,     5,    14,     4,     5,     6,     1,     9,     6,
      10,    26,    11,    13,    12,    25,    16,    28,    33,    35,
      15,    32,    36,     0,    37
};

static const yytype_int8 yycheck[] =
{
       3,    13,     4,    12,    11,    14,    13,    19,    15,    12,
      12,     6,     7,     8,     6,     7,    11,     5,     0,    11,
      10,    14,    13,     9,    13,     3,    11,    14,     4,     4,
       7,    25,    29,    -1,    30
};
...
{
       0,     5,    17,    18,     6,     7,    11,    19,    20,     0,
      10,    13,    13,     9,     8,    20,    11,    21,    11,    13,
      15,    22,    23,    24,    23,     3,    14,    23,    14,     3,
      12,     4,    21,     4,    14,     4,    22,    24
};
...
/* Line 1455 of yacc.c  */
#line 71 "bison.y"
    {dato.nombre = strdup((yyvsp[(1) - (4)].cadena)); dato.valor = (yyvsp[(3) - (4)].num); agregarIdentificador(&tablaDeSimbolos, dato);}
    break;
...
/* Line 1455 of yacc.c  */
#line 72 "bison.y"
    {completarIdentificadores(&identificadoresSinValor);}
    break;
...
/* Line 1455 of yacc.c  */
#line 76 "bison.y"
    {agregarIdentificadorSinValor((yyvsp[(1) - (1)].cadena));}
    break;
...
/* Line 1455 of yacc.c  */
#line 77 "bison.y"
    {agregarIdentificadorSinValor((yyvsp[(1) - (3)].cadena));}
    break;
...
/* Line 1455 of yacc.c  */
#line 85 "bison.y"
    {(yyval.num)=operar((yyvsp[(1) - (3)].num),(yyvsp[(2) - (3)].cadena),(yyvsp[(3) - (3)].num));}
    break;
...
/* Line 1455 of yacc.c  */
#line 87 "bison.y"
    {(yyval.num) = valorAsociadoIdentificador((yyvsp[(1) - (1)].cadena), &tablaDeSimbolos);}
    break;
...
/* Line 1455 of yacc.c  */
#line 89 "bison.y"
    {printf("%c ",(yyvsp[(1) - (3)].caracter));
                                     mostrarExpresion((yyvsp[(2) - (3)].num));
                                     printf("%c ",(yyvsp[(3) - (3)].caracter));}
    break;
